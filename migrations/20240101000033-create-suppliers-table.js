...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      await queryInterface.createTable('suppliers', {
        ...
        category: { type: Sequelize.ENUM('pharmacy', 'surgical', 'lab', 'general_items'), defaultValue: 'pharmacy' },
  ...
  async down(queryInterface, Sequelize) { await queryInterface.dropTable('suppliers'); }
};
